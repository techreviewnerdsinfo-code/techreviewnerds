...
const Page = () => {
  // Pull mock product details by ASIN
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'No. Dell removed the 3.5 mm headphone jack from the 2025 XPS 13. You’ll need a USB‑C audio adapter or Bluetooth headphones.',
    },
  ];

  // Build Product/Offer JSON‑LD. Price stays a string and no rating is passed in.
  ...
  // Combine both schemas into one graph

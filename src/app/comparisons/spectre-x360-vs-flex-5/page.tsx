...
const Page = () => {
  ...
  const verdict = [
    {
      title: 'Choose the HP Spectre x360 if…',
      description: 'You want a premium 2‑in‑1 with an OLED display, longer battery life and a polished design.  It’s ideal for professionals and creatives.',
    },
    {
      title: 'Choose the Lenovo IdeaPad Flex 5 if…',
      description: 'You’re on a tighter budget but still want the versatility of a convertible.  The Flex 5 offers great value and respectable performance for everyday tasks.',
    },
  ];
  const alternatives = [
